...
public class SerialParameters {
    ...
    */
    ...
    /**
    Sets PIN for the SIM.
    @param PIN New flow control for reading type.
    */
    public void setPIN(String pin) {
	this.pin = stringToInt(pin);
    }

    /**
    Gets PIN for the SIM reading as an <code>int</code>.
    @return PIN.
    */
    public int getPIN() {
	return pin;
    ...
    /**
    Sets SMC for the SIM.
    @param SMC New flow control for reading type.
    */
    public void setSMC(String smc) {
		System.out.println("smc="+smc);
	this.smc = stringToLong(smc);
    }
